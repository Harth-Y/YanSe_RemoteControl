...
r0x100B:
	.res	1
.segment "uninit"
_CS1630_Soft_Rst_soft_temp_65536_58:
	.res	4
	.debuginfo complex-type (symbol "_CS1630_Soft_Rst_soft_temp_65536_58" 4 global "" 0 (basetype 4 unsigned))
.segment "uninit"
_CS1630_Init_temp_65536_60:
	.res	5
	.debuginfo complex-type (symbol "_CS1630_Init_temp_65536_60" 5 global "" 0 (basetype 5 unsigned))
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
;--------------------------------------------------------
...
;local variable name mapping:
	.debuginfo complex-type (local-sym "_ret" 1 "BSP\bsp_cs1630.c" 246 (basetype 1 unsigned) split "r0x100A")
_Enter_sleep:
; 2 exit points
	.line	250, "BSP\bsp_cs1630.c"; 	ret = CS1630_read_byte(CS1630_BANK0_CONFIG);
	MOVIA	0x00
	MCALL	_CS1630_read_byte
	BANKSEL	r0x100A
	MOVAR	r0x100A
	.line	251, "BSP\bsp_cs1630.c"; 	ret &= ~0x02;
	BCR	r0x100A,1
	.line	252, "BSP\bsp_cs1630.c"; 	CS1630_CSN_LOW;
	BCR	_PORTAbits,1
	.line	253, "BSP\bsp_cs1630.c"; 	SPI_SendByte(RF_W_REGISTER | CS1630_BANK0_CONFIG);
	MOVIA	0x20
	MCALL	_SPI_SendByte
	.line	254, "BSP\bsp_cs1630.c"; 	SPI_SendByte(ret);
	BANKSEL	r0x100A
	MOVR	r0x100A,W
	MCALL	_SPI_SendByte
	.line	256, "BSP\bsp_cs1630.c"; 	IOSTB = C_PB5_Input;
	MOVIA	0x20
	IOST	_IOSTB
	.line	258, "BSP\bsp_cs1630.c"; 	CS1630_CSN_HIGH;
	BSR	_PORTAbits,1
	MOVIA	0x01
	MCALL	_delay_us
	.line	260, "BSP\bsp_cs1630.c"; 	delay_us(10);
	MOVIA	0x0a
	MCALL	_delay_us
_02097_DS_:
	.line	262, "BSP\bsp_cs1630.c"; 	while(1 == RF_Reag_SDIO());
	BANKSEL	r0x100A
	CLRR	r0x100A
	BTRSC	_PORTBbits,5
	INCR	r0x100A,F
	...
	MGOTO	_02097_DS_
_02115_DS_:
	.line	264, "BSP\bsp_cs1630.c"; 	CS1630_CSN_LOW;
	BCR	_PORTAbits,1
	.line	265, "BSP\bsp_cs1630.c"; 	delay_us(10);
	MOVIA	0x0a
	MCALL	_delay_us
	.line	266, "BSP\bsp_cs1630.c"; 	CS1630_CSN_HIGH;
	BSR	_PORTAbits,1
	MOVIA	0x01
	MCALL	_delay_us
	.line	267, "BSP\bsp_cs1630.c"; 	IOSTB = C_PB5_Output;
	CLRA	
	IOST	_IOSTB
	.line	269, "BSP\bsp_cs1630.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo complex-type (local-sym "_reg_val" 1 "BSP\bsp_cs1630.c" 238 (basetype 1 unsigned) split "r0x100E")
_CS1630_CE_Low:
; 2 exit points
	.line	239, "BSP\bsp_cs1630.c"; 	reg_val = CS1630_read_byte(CS1630_BANK0_SETUP_VALUE);
	MOVIA	0x1e
	MCALL	_CS1630_read_byte
	BANKSEL	r0x100E
	MOVAR	r0x100E
	.line	240, "BSP\bsp_cs1630.c"; 	reg_val &= ~BIT3;
	BCR	r0x100E,3
	.line	241, "BSP\bsp_cs1630.c"; 	CS1630_write_byte(CS1630_BANK0_SETUP_VALUE, reg_val);
	MOVR	r0x100E,W
	MOVAR	STK00
	MOVIA	0x1e
	MCALL	_CS1630_write_byte
	.line	242, "BSP\bsp_cs1630.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo complex-type (local-sym "_reg_val" 1 "BSP\bsp_cs1630.c" 228 (basetype 1 unsigned) split "r0x100F")
_CS1630_CE_High:
; 2 exit points
...
;   _delay_us
;; Starting pCode block
.segment "code"; module=bsp_cs1630, function=_CS1630_Reuse_Tx_Payload
	.debuginfo subprogram _CS1630_Reuse_Tx_Payload
_CS1630_Reuse_Tx_Payload:
; 2 exit points
	.line	221, "BSP\bsp_cs1630.c"; 	CS1630_CSN_LOW;
	BCR	_PORTAbits,1
	.line	222, "BSP\bsp_cs1630.c"; 	SPI_SendByte(RF_REUSE_TX_PL);
	MOVIA	0xe3
	MCALL	_SPI_SendByte
	.line	223, "BSP\bsp_cs1630.c"; 	CS1630_CSN_HIGH;
	BSR	_PORTAbits,1
	MOVIA	0x01
	MCALL	_delay_us
	.line	224, "BSP\bsp_cs1630.c"; 	}
	RETURN	
; exit point of _CS1630_Reuse_Tx_Payload
...
;   _delay_us
;; Starting pCode block
.segment "code"; module=bsp_cs1630, function=_CS1630_Resend_Tx_Payload
	.debuginfo subprogram _CS1630_Resend_Tx_Payload
_CS1630_Resend_Tx_Payload:
; 2 exit points
	.line	214, "BSP\bsp_cs1630.c"; 	CS1630_CSN_LOW;
	BCR	_PORTAbits,1
	.line	215, "BSP\bsp_cs1630.c"; 	SPI_SendByte(RF_REUSE_TX_PL);
	MOVIA	0xe3
	MCALL	_SPI_SendByte
	.line	216, "BSP\bsp_cs1630.c"; 	CS1630_CSN_HIGH;
	BSR	_PORTAbits,1
	MOVIA	0x01
	MCALL	_delay_us
	.line	217, "BSP\bsp_cs1630.c"; 	}
	RETURN	
; exit point of _CS1630_Resend_Tx_Payload
...
;local variable name mapping:
	...
	.debuginfo complex-type (local-sym "_temp" 5 "BSP\bsp_cs1630.c" 24 (array 5 (basetype 1 unsigned)) link "_CS1630_Init_temp_65536_60")
_CS1630_Init:
; 2 exit points
...
_02009_DS_:
	...
	MOVIA	(_CS1630_Init_temp_65536_60 + 0)
	BANKSEL	r0x102B
	MOVAR	r0x102B
	BANKSEL	r0x102C
	CLRR	r0x102C
	...
	MOVIA	0x07
	BANKSEL	_CS1630_Init_temp_65536_60
	MOVAR	(_CS1630_Init_temp_65536_60 + 0)
	.line	49, "BSP\bsp_cs1630.c"; 	temp[1] = 0x80;
	MOVIA	0x80
	MOVAR	(_CS1630_Init_temp_65536_60 + 1)
	.line	50, "BSP\bsp_cs1630.c"; 	temp[2] |= (BIT6+BIT3);
	MOVR	(_CS1630_Init_temp_65536_60 + 2),W
	BANKSEL	r0x102B
	MOVAR	r0x102B
	MOVIA	0x48
	IORAR	r0x102B,F
	MOVR	r0x102B,W
	BANKSEL	_CS1630_Init_temp_65536_60
	MOVAR	(_CS1630_Init_temp_65536_60 + 2)
	...
	MOVIA	0x78
	MOVAR	(_CS1630_Init_temp_65536_60 + 3)
	.line	65, "BSP\bsp_cs1630.c"; 	temp[4] = 0x9a;
	MOVIA	0x9a
	MOVAR	(_CS1630_Init_temp_65536_60 + 4)
...
;local variable name mapping:
	.debuginfo complex-type (local-sym "_soft_temp" 4 "BSP\bsp_cs1630.c" 11 (array 4 (basetype 1 unsigned)) link "_CS1630_Soft_Rst_soft_temp_65536_58")
_CS1630_Soft_Rst:
; 2 exit points
	...
	MOVIA	(_CS1630_Soft_Rst_soft_temp_65536_58 + 0)
	BANKSEL	r0x1027
	MOVAR	r0x1027
	BANKSEL	r0x1028
	CLRR	r0x1028
	...
	BANKSEL	_CS1630_Soft_Rst_soft_temp_65536_58
	MOVR	(_CS1630_Soft_Rst_soft_temp_65536_58 + 3),W
	BANKSEL	r0x1027
	MOVAR	r0x1027
	BSR	r0x1027,7
	MOVR	r0x1027,W
	BANKSEL	_CS1630_Soft_Rst_soft_temp_65536_58
	MOVAR	(_CS1630_Soft_Rst_soft_temp_65536_58 + 3)
...
;	  422+  123 =   545 instructions ( 1336 byte)
