...
;local variable name mapping:
	.debuginfo complex-type (local-sym "_KeyStatus" 1 "BSP\key.c" 56 (basetype 1 unsigned) split "r0x1000")
...
_02105_DS_:
	...
	BTRSC	_PORTAbits,6
	MGOTO	_02022_DS_
	.line	71, "BSP\key.c"; 	return KeyValue;
	MOVIA	0x11
	MGOTO	_02042_DS_
_02022_DS_:
	.line	73, "BSP\key.c"; 	if(!PORTAbits.PA7)
	BTRSC	_PORTAbits,7
	MGOTO	_02024_DS_
	.line	76, "BSP\key.c"; 	return KeyValue;
	MOVIA	0x12
	MGOTO	_02042_DS_
_02024_DS_:
...
_02028_DS_:
	...
	MGOTO	_02030_DS_
_02029_DS_:
	.line	87, "BSP\key.c"; 	default:KeyValue = 0x00;break;
	BANKSEL	r0x1000
	CLRR	r0x1000
_02030_DS_:
	.line	90, "BSP\key.c"; 	toggle_key();
	MCALL	_toggle_key
	.line	92, "BSP\key.c"; 	KeyStatus = PORTB;
	MOVR	_PORTB,W
	BANKSEL	r0x1001
	MOVAR	r0x1001
	.line	93, "BSP\key.c"; 	KeyStatus = KeyStatus & 0x0f;
	MOVIA	0x0f
	ANDAR	r0x1001,F
	.line	95, "BSP\key.c"; 	switch(KeyStatus)
	MOVR	r0x1001,W
	XORIA	0x07
	BTRSS	STATUS,2
	MGOTO	_02109_DS_
...
_02112_DS_:
	MGOTO	_02035_DS_
_02032_DS_:
	.line	98, "BSP\key.c"; 	case(0x0B): KeyValue = KeyValue+0x04;break;
	MOVIA	0x04
	BANKSEL	r0x1000
	ADDAR	r0x1000,F
	MGOTO	_02036_DS_
_02033_DS_:
	.line	99, "BSP\key.c"; 	case(0x0D): KeyValue = KeyValue+0x08;break;
	MOVIA	0x08
	BANKSEL	r0x1000
	ADDAR	r0x1000,F
	MGOTO	_02036_DS_
_02034_DS_:
	.line	100, "BSP\key.c"; 	case(0x0E): KeyValue = KeyValue+0x0c;break;
	MOVIA	0x0c
	BANKSEL	r0x1000
	ADDAR	r0x1000,F
	MGOTO	_02036_DS_
_02035_DS_:
	.line	101, "BSP\key.c"; 	default:KeyValue = 0x00;break;
	BANKSEL	r0x1000
	CLRR	r0x1000
_02036_DS_:
	.line	103, "BSP\key.c"; 	CLRWDT();
	clrwdt
	.line	104, "BSP\key.c"; 	return KeyValue;
	BANKSEL	r0x1000
	MOVR	r0x1000,W
	MGOTO	_02042_DS_
_02038_DS_:
	.line	108, "BSP\key.c"; 	return 0;
	MOVIA	0x00
	MGOTO	_02042_DS_
_02041_DS_:
	.line	111, "BSP\key.c"; 	return 0;
	MOVIA	0x00
_02042_DS_:
	.line	112, "BSP\key.c"; 	}
	RETURN	
